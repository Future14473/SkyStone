...
public class Pipeline {
	...
	public List<Foundation> foundations = new ArrayList<Foundation>();
	public List<Stone> stones = new ArrayList<Stone>();
	public List<SkyStone> skyStones = new ArrayList<SkyStone>();
	//debug steps
...
//		System.runFinalization();
	 ...
	 */
	List<Foundation> computeFoundations(Mat redOutput, Mat blueOutput, Mat yellowOutput, Mat blackOutput, Mat canvas) {
		//Find Contours
